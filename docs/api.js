module.exports = {
	...
	"routes":[
		...
		// blockchain
		{
			...
			"desc":"Returns the current supply of Avian. An estimate using a checkpoint can be returned in 2 cases: on 'slow' devices, and before the UTXO Set snapshot is loaded.",
			"returnType":"number"
		},
		{
			"category":"blockchain",
		...
		// mempool
		{
			...
			"desc":"Returns the number of transactions in Avian Core's mempool.",
			"returnType":"integer"
		},
		{
			"category":"mempool",
		...
		// price
		{
			"category":"price",
			"url":"/api/price",
			"desc":"Returns the price of 1 AVN, in USD, EUR, GBP, and XAU",
			"returnType":"json"
		},
		{
			"category":"price",
			"url":"/api/price/:currency",
			"desc":"Returns the price of 1 AVN, in one of USD, EUR, GBP, XAU",
		...
		},
		{
			...
			"desc":"Returns the market cap of Avian, in one of USD, EUR, GBP, XAU",
			"params":[{name: "currency", "options": ["usd", "eur", "gbp", "xau"]}],
			"returnType":"number",
		...
		// fun
		{
			"category":"fun",
			"url":"/api/quotes/all",
			"desc":"Returns the full curated list of Avian quotes.",
			"returnType":"json"
		},
		{
			"category":"fun",
			"url":"/api/quotes/:index",
			"desc":"Returns the Avian quote with the given index from the curated list.",
			"returnType":"json",
		...
		},
		{
			...
			"desc":"Returns a random Avian quote from the curated list.",
			"returnType":"json"
		},
		{
			"category":"fun",
			"url":"/api/holidays/all",
			"desc":"Returns the full curated list of Avian Holidays.",
			"returnType":"json"
		},
		{
			"category":"fun",
			"url":"/api/holidays/today",
			"desc":"Returns the Avian Holidays celebrated 'today' (i.e. at the time the API call is made).",
			"optionalParams": {
		...
		},
		{
			...
			"desc":"Returns the Avian Holidays celebrated on the specified day, using one of the following formats: yyyy-MM-DD, MM-DD.",
			"returnType":"json",

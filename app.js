...
const cdnItems = [
	...
	[`img/network-mainnet/coin-icon.png`, `image/png`, "binary"],
	...
	[`img/network-testnet/logo.png`, `image/png`, "binary"],
	[`img/network-testnet/coin-icon.png`, `image/png`, "binary"],
	[`img/network-signet/logo.png`, `image/png`, "binary"],
	[`img/network-signet/coin-icon.png`, `image/png`, "binary"],
	[`img/network-regtest/logo.png`, `image/png`, "binary"],
	[`img/network-regtest/coin-icon.png`, `image/png`, "binary"],

	[`img/network-mainnet/favicon.png`, `image/png`, "binary"],
	[`img/network-testnet/favicon.png`, `image/png`, "binary"],
	[`img/network-signet/favicon.png`, `image/png`, "binary"],
	[`img/network-regtest/favicon.png`, `image/png`, "binary"],

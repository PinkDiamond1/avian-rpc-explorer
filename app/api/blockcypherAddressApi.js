...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	return new Promise(async (resolve, reject) => {
		...
		var mainnetUrl = `https://api.blockcypher.com/v1/avn/main/addrs/${address}?limit=${limitOffset}`;
		var testnetUrl = `https://api.blockcypher.com/v1/avn/test3/addrs/${address}?limit=${limitOffset}`;

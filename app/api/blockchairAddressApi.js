...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	...
	return new Promise(async (resolve, reject) => {
		var mainnetUrl = `https://api.blockchair.com/avian/dashboards/address/${address}/?offset=${offset}`;
		var testnetUrl = `https://api.blockchair.com/avian/testnet/dashboards/address/${address}/?offset=${offset}`;

...
module.exports = {
	...
	demoSiteUrlsByNetwork: {
		"main": "https://avianexplorer.org",
		"test": "https://testnet.avianexplorer.org",
		"signet": "https://signet.avianexplorer.org",
	},
	knownTransactionsByNetwork: {
		main: "c20e90aa1b490fb54b5f410e7f5eff62f94362dac1238f20762da660ef7dd85b",
	...
	miningPoolsConfigUrls:[
		"https://raw.githubusercontent.com/avn21/Avian-Known-Miners/master/miners.json",
		"https://raw.githubusercontent.com/0xB10C/known-mining-pools/master/pools.json",
		"https://raw.githubusercontent.com/avncom/Blockchain-Known-Pools/master/pools.json",
		"https://raw.githubusercontent.com/blockchain/Blockchain-Known-Pools/master/pools.json"
	],
	maxBlockWeight: 4000000,
	maxBlockSize: 1000000,
	minTxBytes: 166, // ref: https://en.avian.it/wiki/Maximum_transaction_rate
	minTxWeight: 166 * 4, // hack
	difficultyAdjustmentBlockCount: 2016,
	maxSupplyByNetwork: {
		"main": new Decimal(21000000000),
	...
	currencyUnitsByName:{"AVN":currencyUnits[0], "mAVN":currencyUnits[1], "bits":currencyUnits[2], "sat":currencyUnits[3]},
	...
	coinSupplyCheckpointsByNetwork: {
		"main": [ 928420, new Decimal(2321050000) ],
	...
	utxoSetCheckpointsByNetwork: {
		"main": {"height":928419,"bestblock":"000000000017001ffbbacaa63b12bb5e646e7c30730eef9e57099c28fd208209","transactions":362314,"txouts":14144077,"bogosize":1060805767,"hash_serialized_2":"adfb6f4467bf94524af4ed70c17f5896e797d2f5af431dc47a3cd367b5b037e1","disk_size":657370098,"total_amount":"2321047500.00000000","lastUpdated":1632692076775}
	},
	
	genesisBlockHashesByNetwork:{
		"main":	"000000cdb10fc01df7fba251f2168ef7cd7854b571049db4902c315694461dd0",
		"test":	"000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943",
		"regtest": "0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206",
		"signet":  "00000008819873e925422c1ff0f99f7cc9bbb232af63a077a480a3633bee1ef6", 
	},
	genesisCoinbaseTransactionIdsByNetwork: {
		"main":	"63d9b6b6b549a2d96eb5ac4eb2ab80761e6d7bffa9ae1a647191e08d6416184d",
	...
	genesisCoinbaseTransactionsByNetwork:{
		"main": {
			...
			"txid": "63d9b6b6b549a2d96eb5ac4eb2ab80761e6d7bffa9ae1a647191e08d6416184d",
			"hash": "63d9b6b6b549a2d96eb5ac4eb2ab80761e6d7bffa9ae1a647191e08d6416184d",
			"size": 204,
			"vsize": 204,
			"version": 1,
	...
	historicalData: avnFun.items,
	exchangeRateData:{
		jsonUrl:"https://api.coingecko.com/api/v3/simple/price?ids=avian-network&vs_currencies=usd",
		responseBodySelectorFunction:function(responseBody) {
			// console.log("Exchange Rate Response: " + JSON.stringify(responseBody));

			if(responseBody["avian-network"]["usd"]) {
				return {"usd": responseBody["avian-network"]["usd"]}
			} else {
				return null;
			}
		}
